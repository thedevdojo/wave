<header class="w-full">
    <div class="flex space-x-3 w-full">
        <div class="flex overflow-hidden flex-shrink-0 rounded divide-x divide-gray-700">
            <div class="relative" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                <button class="flex relative items-center px-4 py-2 text-xs font-medium text-white bg-gray-900 dark:bg-zinc-800 hover:bg-gray-800 dark:hover:bg-zinc-700">
        ...
        <button wire:click="refresh" class="flex-shrink-0 p-2 text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-800 rounded ring-1 ring-gray-200 dark:ring-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700">
        ...
        <div class="flex overflow-hidden flex-shrink-0 rounded divide-x divide-gray-200 dark:divide-zinc-600 ring-1 ring-gray-200 dark:ring-zinc-600">
        ...
        <div class="flex overflow-hidden flex-shrink-0 rounded divide-x divide-gray-200 dark:divide-zinc-600 ring-1 ring-gray-200 dark:ring-zinc-600">
            <button x-on:click="view='list'" :class="{ 'bg-gray-100 dark:bg-zinc-700' : view == 'list', 'bg-white dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-700' : view != 'list' }" class="flex items-center px-4 py-2 text-xs font-medium text-gray-700 dark:text-zinc-200">
            ...
            <button x-on:click="view='grid'" :class="{ 'bg-gray-100 dark:bg-zinc-700' : view == 'grid', 'bg-white dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-700' : view != 'grid' }" class="flex items-center px-4 py-2 text-xs font-medium text-gray-700 dark:text-zinc-200">
    ...
    <!-- Progress Bar -->
    <div x-show="isUploading" class="overflow-hidden relative top-0 right-0 left-0 mt-2 h-2 rounded-full bg-zinc-100 dark:bg-zinc-800">
