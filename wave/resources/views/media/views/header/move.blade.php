<x-filament::modal id="move-file-modal" width="lg">
    <x-slot name="trigger">
        <button class="flex items-center px-4 py-2 text-xs font-medium text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-700">
