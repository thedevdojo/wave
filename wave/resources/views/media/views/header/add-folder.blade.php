<x-filament::modal id="create-folder-modal" width="lg">
    <x-slot name="trigger">
        <button class="flex items-center px-4 py-2 text-xs font-medium text-white bg-gray-900 dark:bg-zinc-800 outline-none focus:outline-none hover:bg-gray-800 dark:hover:bg-zinc-700">
