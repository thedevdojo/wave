<active-file x-show="activeFileDrawer" class="relative flex-shrink-0 w-[17rem] h-full lg:block hidden bg-gray-50 dark:bg-zinc-800 rounded-md p-3">
    <template x-if="!activeFileSelected()">
        <div class="flex justify-center items-center h-32 text-sm text-gray-500 dark:text-zinc-400">
    ...
    <template x-if="activeFileSelected() && clientSideActive">
        <div class="w-full h-auto">
            <div class="flex justify-center items-center p-3 w-full h-auto border-b border-neutral-200 dark:border-zinc-700">
            ...
            <div class="p-2 space-y-2 h-auto text-xs break-all text-neutral-500 dark:text-zinc-400">
                <p><strong class="text-neutral-600 dark:text-zinc-300">Name:</strong> <span x-text="active.name"></span></p>
                <p><strong class="text-neutral-600 dark:text-zinc-300">Type:</strong> <span x-text="active.type"></span></p>
                <p x-show="active.type == 'folder'"><strong class="text-neutral-600 dark:text-zinc-300">File count:</strong> <span x-text="active.items"></span></p>
                <p x-show="active.type != 'folder'"><strong class="text-neutral-600 dark:text-zinc-300">Filesize:</strong> <span x-text="active.size"></span></p>
                <p x-show="active.type != 'folder'"><strong class="text-neutral-600 dark:text-zinc-300">Full URL:</strong> <a :href="active.url" target="_blank" class="text-blue-600 dark:text-blue-400 underline hover:text-blue-500 dark:hover:text-blue-300">open in new tab</a></p>
                <p x-show="active.type != 'folder'"><strong class="text-neutral-600 dark:text-zinc-300">Last Modified:</strong> <span x-text="active.last_modified"></span></p>
            </div>
        </div>
    </template>
</active-file>