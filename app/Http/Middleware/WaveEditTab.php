...
class WaveEditTab
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        if ($request->path() == 'wave') {
            ...
            $sidebar_links = '';
            $sidebar_links .= view('wave::partials.wave_edit_tab_item', ['text' => 'Home', 'slug' => 'pages', 'link' => '/', 'key' => 'h', 'icon' => 'phosphor-house'])->render();
            $sidebar_links .= view('wave::partials.wave_edit_tab_item', ['text' => 'Users', 'slug' => 'users', 'link' => '/admin/users', 'key' => 'u', 'icon' => 'phosphor-users'])->render();
            $sidebar_links .= view('wave::partials.wave_edit_tab_item', ['text' => 'Media', 'slug' => 'media', 'link' => '/admin/media', 'key' => 'm', 'icon' => 'phosphor-images-square'])->render();
            $sidebar_links .= view('wave::partials.wave_edit_tab_item', ['text' => 'Dashboard', 'slug' => 'dashboard', 'link' => '/dashboard', 'key' => 'd', 'icon' => 'phosphor-speedometer'])->render();
            // $sidebar_links .= view('wave::partials.wave_menu_item',  ['text' => 'Designs', 'slug' => 'designs'])->render();            
            // $sidebar_links .= view('wave::partials.wave_menu_item', ['text' => 'Settings', 'slug' => 'settings'])->render();
            // $sidebar_links .= view('wave::partials.wave_menu_item', ['text' => 'Packages', 'slug' => 'packages'])->render();
            $sidebar_links .= view('wave::partials.wave_edit_tab_item', ['text' => 'Admin', 'slug' => 'admin', 'link' => '/admin', 'key' => 'a', 'phosphor-crown-simple'])->render();
            //$sidebar_links .= view('wave::partials.wave_menu_item', ['text' => 'Learn', 'slug' => 'learn'])->render(); 

            $cornerTabHTML = <<<HTML
                <div x-data="{ 
                            collapsed: \$persist(false).as('wave_edit_tab_collapsed'),
                            visible: false, 
                            iniFrame() {
