...
Before creating a bug report, please check the [existing issues](https://github.com/thedevdojo/wave/issues) to avoid duplicates.
...
- Search [existing issues](https://github.com/thedevdojo/wave/issues) to avoid duplicates
