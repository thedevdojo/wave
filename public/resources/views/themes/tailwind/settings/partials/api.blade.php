<div class="flex flex-col px-10 py-8">
	<form action="{{ route('wave.settings.api.post') }}" method="POST">
		...
		<div class="flex justify-end w-full mt-2">
			<button class="flex self-end justify-center w-auto px-4 py-2 mt-5 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md  hover:bg-wave-500 focus:outline-none focus:border-wave-700 focus:shadow-outline-wave active:bg-wave-700" dusk="update-profile-button">Create New Key</button>
		</div>
						...
						<div class="flex flex-col justify-between w-full mt-2">
							<form action="{{ route('wave.settings.api.put') }}" method="POST">
								...
								<p class="flex justify-end mt-5">
									...
									<button type="submit" class="inline-flex justify-center px-4 py-2 text-base font-medium leading-6 text-white transition duration-150 ease-in-out border border-transparent rounded-md shadow-sm  hover:bg-wave-500 focus:outline-none focus:border-wave-700 focus:shadow-outline-wave sm:text-sm sm:leading-5">Update</button>
								</p>
								{{ csrf_field() }}
							</form>
						</div>
