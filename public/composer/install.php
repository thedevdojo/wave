<?php
    ...
    if (!file_exists($autoloadPath)) {
        ...
        $binDir = dirname($currentPhpBinaryPath);

        // Append 'php' to the directory path
        $phpPath = $binDir . '/php';
        ...
        $command = "cd \"$projectRoot\" && \"$phpPath\" \"$composerPath\" install 2>&1";
...
<body class="flex overflow-hidden relative flex-col justify-start items-start w-screen h-screen bg-black">
    ...
    <div class="overflow-y-scroll relative z-20 p-5 pt-10 w-full h-full h-screen font-mono text-xs text-white rounded-xl" id="container">
