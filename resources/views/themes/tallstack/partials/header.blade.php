    ...
    <div class="px-8 mx-auto max-w-7xl xl:px-5">
        <div class="flex relative z-30 justify-between items-center h-24 md:space-x-6">
            ...
            <div class="flex flex-grow justify-end -my-2 -mr-2 md:hidden">
                <button @click="mobileMenuOpen = true" type="button" class="inline-flex justify-center items-center p-2 text-zinc-400 rounded-full transition duration-150 ease-in-out hover:text-zinc-500 hover:bg-zinc-100 focus:outline-none focus:bg-zinc-100 focus:text-zinc-500">
