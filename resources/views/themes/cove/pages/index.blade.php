                    ...
                    <div class="w-full sm:w-4/5 lg:w-1/2">
                        <blockquote class="flex flex-row-reverse col-span-1 justify-between items-center p-6 w-full bg-white rounded-xl shadow sm:flex-row">
                            <div class="flex flex-col pl-5 sm:pr-8">
                                ...
                                <h3 class="mt-3 text-base font-medium leading-5 truncate text-zinc-800 sm:pl-12">Jane Cooper <span class="mt-1 text-sm leading-5 truncate text-zinc-500">- CEO SomeCompany</span></h3>
                                <p class="mt-1 text-sm leading-5 truncate text-zinc-500"></p>
                            </div>
                            <img class="flex-shrink-0 w-24 h-24 rounded-full bg-zinc-300" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60" alt="">
                        </blockquote>
                        <blockquote class="flex flex-row-reverse col-span-1 justify-between items-center p-6 my-5 w-full bg-white rounded-lg shadow sm:flex-row">
                            <div class="flex flex-col pl-5 sm:pr-10">
                                ...
                                <h3 class="mt-3 text-base font-medium leading-5 truncate text-zinc-800 sm:pl-12">John Doe <span class="mt-1 text-sm leading-5 truncate text-zinc-500">- CEO SomeCompany</span></h3>
                                <p class="mt-1 text-sm leading-5 truncate text-zinc-500"></p>
                            </div>
                            <img class="flex-shrink-0 w-24 h-24 rounded-full bg-zinc-300" src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&aauto=format&fit=facearea&facepad=4&w=256&h=256&q=60" alt="">
                        </blockquote>
                        <blockquote class="flex flex-row-reverse col-span-1 justify-between items-center p-6 w-full bg-white rounded-lg shadow sm:flex-row">
                            <div class="flex flex-col pl-5 sm:pr-10">
                                <div class="relative sm:pl-12">
                                    <svg class="hidden absolute left-0 w-10 h-10 text-blue-500 fill-current sm:block"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125">
                                ...
                                <h3 class="mt-3 text-base font-medium leading-5 truncate text-zinc-800 sm:pl-12">John Smith <span class="mt-1 text-sm leading-5 truncate text-zinc-500">- CEO SomeCompany</span></h3>
                                <p class="mt-1 text-sm leading-5 truncate text-zinc-500"></p>
                            </div>
                            <img class="flex-shrink-0 w-24 h-24 rounded-full bg-zinc-300" src="https://images.unsplash.com/photo-1545167622-3a6ac756afa4?ixlib=rrb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&aauto=format&fit=facearea&facepad=4&w=256&h=256&q=60" alt="">
                        </blockquote>
                    </div>
                </div>
            </div>
