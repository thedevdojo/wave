        ...
        <div class="relative">
            <ul class="flex flex-1 justify-center items-center p-1 list-none rounded-md text-zinc-900 group">
                <li class="px-0.5" @mouseover="navigationMenuOpen=true; navigationMenuReposition($el); navigationMenu='platform'" @mouseleave="navigationMenuLeave()">
                    <button :class="{ 'text-zinc-900 bg-zinc-100' : navigationMenu=='platform', 'hover:text-zinc-900' : navigationMenu!='platform' }" class="inline-flex justify-center items-center px-4 py-2 w-max h-10 text-sm font-medium rounded-md transition-colors focus:outline-none disabled:opacity-50 disabled:pointer-events-none group">
                        <span>Platform</span>
                ...
                <li class="px-0.5">
                    <a href="/pricing" class="inline-flex justify-center items-center px-4 py-2 w-max h-10 text-sm font-medium rounded-md transition-colors hover:text-zinc-900 focus:outline-none disabled:opacity-50 disabled:pointer-events-none hover:bg-zinc-100 group">
                        Pricing
                    </a>
                </li>
                <li class="px-0.5">
                    <a href="/blog" class="inline-flex justify-center items-center px-4 py-2 w-max h-10 text-sm font-medium rounded-md transition-colors hover:text-zinc-900 focus:outline-none disabled:opacity-50 disabled:pointer-events-none hover:bg-zinc-100 group">
                        Blog
                    </a>
                </li>
            </ul>
...
@else
    <x-button href="{{ route('login') }}" tag="a" class="text-sm" class="flex-shrink-0">View Dashboard</x-button>
@endguest
