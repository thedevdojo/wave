	...
	<x-app.container x-data class="space-y-6" x-cloak>
        <div class="w-full">
            ...
            <div class="py-5 space-y-5">
                ...
                <p>You can modify this view inside your theme folder at <span class="px-2 py-1 font-mono bg-gray-200 rounded-md dark:bg-gray-800 dark:text-white">pages/subscription/welcome</span>.</p>
            </div>
        </div>
    </x-app.container>
