...
<body class="flex flex-col min-h-screen @if(Request::is('/')){{ 'bg-white' }}@else{{ 'bg-zinc-50' }}@endif @if(config('wave.dev_bar')){{ 'pb-10' }}@endif">
    ...
    {{-- <div class="flex absolute z-50 justify-center items-center w-screen h-screen">
        <div class="mx-auto w-full max-w-7xl h-full border-r-2 border-l-2 border-zinc-900"></div>
    </div> --}}
