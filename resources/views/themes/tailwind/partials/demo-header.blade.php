<div class="relative bottom-0 left-0 z-30 w-full h-16 bg-gradient-to-r from-wave-500 via-wave-600 to-purple-500">
    <div class="flex items-center justify-between w-full h-full px-3 mx-auto max-w-7xl">
        <div class="relative flex items-center">
            <div class="flex items-center text-sm text-blue-200">
                <p class="font-medium text-blue-100">This is a demo of <a href="https://devdojo.com/wave">Wave.</a></p>
