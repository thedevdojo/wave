<footer class="@if(Request::is('/')){{ 'bg-white' }}@else{{ 'bg-gray-50' }}@endif border-t border-gray-200 relative">
    <div class="relative z-20 max-w-screen-xl px-8 py-12 mx-auto lg:py-16 xl:px-5">
