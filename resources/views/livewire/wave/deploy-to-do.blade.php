<div>
    <div class="flex flex-col items-center justify-center w-screen h-screen bg-zinc-50">

        <!-- Back to Admin Button -->
        <a href="{{ url('admin') }}" class="absolute top-0 left-0 flex items-center pt-5 pl-5 mb-5 ml-5 font-medium text-zinc-900 group lg:w-auto lg:items-center lg:justify-center md:mb-0">
            ...
            <span class="mx-auto ml-1 text-sm font-bold leading-none text-zinc-900 select-none">Back to Admin</span>
        </a>


        <div id="notification" class="flex items-center justify-between hidden w-full max-w-lg px-8 py-5 mb-10 text-white bg-zinc-500 rounded-lg">
        ...
        @if(!$app_id)
            <div class="w-full max-w-lg mx-auto overflow-hidden bg-white border border-zinc-100 rounded-lg shadow-xl">
                ...
                <div class="relative mb-8">
                        ...
                        <input type="text" wire:model.live="repo" placeholder="thedevdojo/wave" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-zinc-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" name="repo">
                    </div>
                ...
                <input type="password" wire:model.live="api_key" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-zinc-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" name="api_key">
                <div class="block">
        ...
        @else
            <div class="w-full max-w-lg mx-auto">
                ...
                <div class="overflow-hidden bg-white border border-zinc-100 rounded-lg shadow-xl">
                    <div class="relative flex items-center w-full h-20 pl-5 text-white bg-center bg-cover bg-gradient-to-br from-blue-500 to-blue-600" style="background-image:url('{{ Storage::url('/settings/April2021/deploy-banner.png') }}')">
                        <img src="{{ Storage::url('/settings/April2021/deploy-to-do.png') }}" class="w-10 h-10">
                ...
                @foreach($deployments['deployments'] as $deployment)
                    ...
                    @endphp
                    <div class="flex items-center p-5 overflow-hidden bg-white border border-zinc-100 rounded-lg shadow-xl">
