<div class="flex items-center justify-between p-5 m-8 bg-red-200 border border-red-400 rounded-lg">
	...
	<div onclick="document.getElementById('confirmCancel').__x.$data.open = true" class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg cursor-pointer">Cancel</div>
</div>