<div class="fixed inset-0 z-40 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
    <div id="toast" x-data x-cloak
        ...
        x-transition:enter-start="translate-y-2 opacity-0 sm:translate-y-0 sm:ltr:translate-x-2 sm:rtl:-translate-x-2"
        x-transition:enter-end="translate-y-0 opacity-100 sm:ltr:translate-x-0 sm:rtl:translate-x-0"
        ...
        <div class="relative overflow-hidden rounded-lg shadow-xs">
            <div class="px-4 py-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0 pe-0.5">
                    ...
                    <div class="flex-1 w-0 ps-3.5 ms-1 border-l border-zinc-100">
                    ...
                    <div class="flex self-start flex-shrink-0 ms-4">
            ...
            <div id="toast_bar" class="absolute bottom-0 start-0 w-full h-1 transition-all ease-out"
