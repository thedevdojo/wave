...
<div id="changeLogNotification" class="fixed bottom-0 end-0 z-50 flex items-end justify-center px-4 py-6 transition-all duration-200 ease-out transform translate-y-0 opacity-100 cursor-pointer pointer-events-none hover:-translate-y-1 sm:p-6 sm:items-start sm:justify-end" data-href="{{ route('changelog', ['changelog' => $changeLogNotification->id]) }}">
	<div id="changelog_content" class="relative w-full max-w-sm bg-white border rounded-lg shadow-lg pointer-events-auto dark:bg-zinc-700 border-zinc-200 dark:border-zinc-800">
		<div class="relative p-5">
			<span id="changelog_close" class="absolute top-0 end-0 inline-flex mt-5 me-5 transition duration-150 ease-in-out cursor-pointer text-zinc-400 focus:outline-none focus:text-zinc-500">
				<svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
				</svg>
			</span>
			<h4 class="w-full overflow-hidden text-sm font-medium leading-5 pe-7 whitespace-nowrap text-zinc-900 dark:text-white text-ellipsis">{{ $changeLogNotification->title }}</h4>
