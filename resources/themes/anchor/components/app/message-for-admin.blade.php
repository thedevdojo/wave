<p>You're logged in with an <strong>Admin</strong> role. Did you know that you can use <a href="https://devdojo.com/wave/docs/concepts/blade-directives" target="_blank" class="underline">custom blade directives</a> to check if a user is an admin user</p>
