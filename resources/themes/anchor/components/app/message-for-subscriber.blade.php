...
&#64;endsubscriber</code></pre>
    <div class="p-5">
        <p><a href="https://devdojo.com/wave/docs/blade-directives" class="underline">Click here to learn more</a> about Blade directives you can use in your Wave application.</p>
    </div>
</div>