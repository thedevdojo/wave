<div {{ $attributes->twMerge('lg:px-5 mx-auto w-full lg:px-0') }}>
    <a href="{{ $href ?? '' }}" wire:navigate class="inline-flex items-center px-2.5 py-1.5 mb-3 lg:mb-1 md:mb-6 text-[0.7rem] font-semibold rounded-full border cursor-pointer text-zinc-900 bg-zinc-100 border-zinc-200 group">
