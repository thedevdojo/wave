<section>
    ...
    <div class="text-center">
        <div class="grid grid-cols-2 gap-x-6 gap-y-12 mt-12 text-center lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
            <div>
                <div class="flex justify-center items-center mx-auto bg-gray-100 rounded-full size-12">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="font-medium text-gray-900">Secure Authentication</h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="font-medium text-gray-900">Third-Party Integrations</h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="font-medium text-gray-900">Customizable Themes</h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="font-medium text-gray-900">Easy Setup</h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="font-medium text-gray-900">Community Support</h3>
                    <p class="mt-2 text-sm text-gray-500">
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="font-medium text-gray-900">File Management</h3>
                    <p class="mt-2 text-sm text-gray-500">
