<section class="relative top-0 flex flex-col items-center justify-center w-full min-h-screen -mt-24 bg-white lg:min-h-screen">
        ...
        <div class="flex flex-col items-center justify-between flex-1 w-full max-w-2xl gap-6 px-8 pt-32 mx-auto text-start md:px-12 xl:px-20 lg:pt-32 lg:pb-16 lg:max-w-7xl lg:flex-row">
            <div class="w-full lg:w-1/2">
                <h1 class="text-6xl font-bold tracking-tighter text-start sm:text-7xl md:text-8xl sm:text-center lg:text-start text-zinc-900 text-balance">
                    <span class="block origin-left lg:scale-90 text-nowrap">Ship in Days</span> <span class="pe-4 text-transparent text-neutral-600 bg-clip-text bg-gradient-to-b from-neutral-900 to-neutral-500">Not Weeks</span>
                </h1>
                <p class="mx-auto mt-5 text-2xl font-normal text-start sm:max-w-md lg:ms-0 lg:max-w-md sm:text-center lg:text-start text-zinc-500">
                    Customize this to highlight your product’s unique selling points<span class="hidden sm:inline"> and features</span>.
                </p>
                <div class="flex flex-col items-center justify-center gap-3 mx-auto mt-8 md:gap-2 lg:justify-start md:ms-0 md:flex-row">
            ...
            <div class="flex items-center justify-center w-full mt-12 lg:w-1/2 lg:mt-0">
                <img alt="Wave Character" class="relative w-full lg:scale-125 xl:ltr:translate-x-6 xl:rtl:-translate-x-6" src="/wave/img/character.png" style="max-width:450px;">
            </div>
        </div>
