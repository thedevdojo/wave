        ...
        <div class="flex flex-col items-center justify-between flex-1 w-full max-w-2xl gap-6 px-8 pt-32 mx-auto text-left md:px-12 xl:px-20 lg:pt-32 lg:pb-16 lg:max-w-7xl lg:flex-row">
            <div class="w-full lg:w-1/2">
                <h1 class="text-6xl font-bold tracking-tighter text-left sm:text-7xl md:text-8xl sm:text-center lg:text-left text-zinc-900 text-balance">
                    <span class="block origin-left lg:scale-90 text-nowrap">Lansează în zile</span> <span class="pr-4 text-transparent text-neutral-600 bg-clip-text bg-gradient-to-b from-neutral-900 to-neutral-500">nu în săptămâni</span>
                </h1>
                <p class="mx-auto mt-5 text-2xl font-normal text-left sm:max-w-md lg:ml-0 lg:max-w-md sm:text-center lg:text-left text-zinc-500">
                    Personalizează acest text pentru a evidenția punctele forte și caracteristicile unice ale produsului tău.
                </p>
                <div class="flex flex-col items-center justify-center gap-3 mx-auto mt-8 md:gap-2 lg:justify-start md:ml-0 md:flex-row">
                    <x-button size="lg" class="w-full lg:w-auto">Buton principal</x-button>
                    <x-button size="lg" color="secondary" class="w-full lg:w-auto">Buton secundar</x-button>
                </div>
            </div>
            ...
            <div class="grid h-auto grid-cols-1 px-8 py-10 mx-auto space-y-5 divide-y max-w-7xl lg:space-y-0 lg:divide-y-0 divide-zinc-200 lg:py-0 lg:divide-x md:px-12 lg:px-20 lg:divide-zinc-200 lg:grid-cols-3">
                <div class="">
                    ...
                    <p class="mt-2 text-sm font-medium text-zinc-500">
                        De ce ar fi utilizatorii interesați să folosească produsul tău. <span class="hidden lg:inline">Explică-le mai multe aici.</span>
                    </p>
                </div>
                <div class="pt-5 lg:pt-0 lg:px-10">
                    <h3 class="font-medium text-zinc-900">Puncte de durere</h3>
                    <p class="mt-2 text-sm text-zinc-500">
                        Care sunt problemele pe care SaaS-ul tău dorește să le rezolve? <span class="hidden lg:inline">Explică aici.</span>
                    </p>
                </div>
                <div class="pt-5 lg:pt-0 lg:px-10">
                    <h3 class="font-medium text-zinc-900">Avantaj unic</h3>
                    <p class="mt-2 text-sm text-zinc-500">
                        Explică avantajul tău unic față de alții de pe piață.
                    </p>
                </div>
            </div>
        </div>
