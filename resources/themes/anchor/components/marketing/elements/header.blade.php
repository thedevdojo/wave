...
>
    ...
    <x-container>
        <div class="z-30 flex items-center justify-between h-24 md:space-x-8">
            ...
            <nav class="h-full">
                <ul id="menu" class="flex items-center justify-center flex-1 hidden w-full h-full ml-0 border-t border-gray-100 gap-x-8 md:flex md:w-auto md:items-center md:border-t-0 md:flex-row">
                    <li @mouseenter="showOverlay=true" @mouseleave="showOverlay=false" class="z-30 flex flex-col items-start h-full border-b border-gray-100 md:border-b-0 group md:flex-row md:items-center">
                        <a href="#_" class="flex items-center w-full h-16 gap-1 px-6 text-sm font-semibold text-gray-700 transition duration-300 md:h-full md:px-0 md:w-auto hover:text-gray-900">
                        ...
                        <div class="top-0 left-0 invisible hidden w-screen space-y-3 transition-transform duration-300 ease-out -translate-y-2 bg-white border-t border-b border-gray-100 shadow-md opacity-0 md:mt-24 md:block group-hover:block group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 md:absolute">
                            <ul class="flex flex-col justify-between max-w-6xl px-8 mx-auto md:px-12 md:flex-row">
                    ...
                    <li @mouseenter="showOverlay=true" @mouseleave="showOverlay=false" class="z-30 flex flex-col items-start h-full border-b border-gray-100 md:border-b-0 group md:flex-row md:items-center">
                        ...
                        <div class="top-0 left-0 invisible hidden w-screen space-y-3 transition-all duration-300 ease-out -translate-y-2 bg-white border-t border-b border-gray-100 shadow-sm opacity-0 md:block group-hover:block group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 md:absolute md:mt-24">
                            <ul class="flex flex-col justify-between max-w-6xl px-8 mx-auto md:flex-row md:px-12">
                                <div class="flex flex-row w-full border-l border-r divide-x divide-zinc-100 border-zinc-100">
                    ...
                    <li class="h-16 px-6 border-b border-gray-100 md:px-0 md:border-b-0 md:h-full">
