<header 
    ...
    " 
    :class="{ 'border-zinc-200/60 bg-white/90 backdrop-blur-lg' : scrolled, 'border-transparent bg-transparent translate-y-0' : !scrolled }" 
    ...
    <x-container>
        <div class="z-30 flex items-center justify-between h-24 md:space-x-8">
            ...
            <nav :class="{ 'hidden md:flex' : !mobileMenuOpen, 'block md:flex md:relative absolute top-0 left-0 md:w-auto w-screen md:h-auto h-screen md:pt-0 pt-24 pointer-events-none md:z-10 z-50' : mobileMenuOpen }" class="h-full">
                <ul :class="{ 'hidden md:flex' : !mobileMenuOpen, 'flex flex-col absolute md:relative md:w-auto w-screen h-full md:h-full md:overflow-auto overflow-scroll md:pb-0 pb-24 bg-white md:bg-transparent' : mobileMenuOpen }" id="menu" class="items-stretch pointer-events-auto md:items-center justify-start md:justify-center flex-1 w-full h-full ml-0 border-t border-zinc-100 gap-x-8 md:w-auto md:items-center md:border-t-0 md:flex-row">
                    <li @mouseenter="showOverlay=true" @mouseleave="showOverlay=false" class="z-30 flex flex-col items-start h-auto md:h-full border-b border-zinc-100 md:border-b-0 group md:flex-row md:items-center">
                        <a href="#_" class="flex items-center w-full hover:bg-zinc-100 md:hover:bg-transparent h-16 gap-1 px-6 text-sm font-semibold text-zinc-700 transition duration-300 md:h-full md:px-0 md:w-auto hover:text-zinc-900">
                        ...
                        <div class="top-0 left-0 invisible hidden w-screen space-y-3 transition-transform duration-300 ease-out md:-translate-y-2 bg-white border-t border-b border-zinc-100 shadow-md opacity-0 md:mt-24 md:block group-hover:block group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 md:absolute">
                            <ul class="flex flex-col justify-between max-w-6xl mx-auto md:px-12 md:flex-row">
                                <li class="w-full border-l border-zinc-100 md:w-1/5">
                                    <a href="#_" onclick="demoButtonClickMessage(event)" class="block h-full p-6 text-lg font-semibold hover:bg-zinc-50 lg:p-7 lg:py-10">
                                ...
                                <li class="w-full border-l border-zinc-100 md:w-1/5">
                                    <a href="#_" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button in your theme folder').icon('heroicon-o-pencil-square').iconColor('info').send()" class="block h-full p-6 text-lg font-semibold hover:bg-zinc-50 lg:p-7 lg:py-10">
                    ...
                    <li @mouseenter="showOverlay=true" @mouseleave="showOverlay=false" class="z-30 flex flex-col items-start h-auto md:h-full border-b border-zinc-100 md:border-b-0 group md:flex-row md:items-center">
                        ...
                        <div class="top-0 left-0 invisible hidden w-screen space-y-3 transition-all duration-300 ease-out -translate-y-2 bg-white border-t border-b border-zinc-100 shadow-sm opacity-0 md:block group-hover:block group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 md:absolute md:mt-24">
                    ...
                    <li class="h-16 flex-shrink-0 border-b border-zinc-100 md:border-b-0 md:h-full">
                        <a href="{{ route('pricing') }}" class="flex md:px-0 px-6 items-center h-full hover:bg-zinc-100 md:hover:bg-transparent text-sm font-semibold text-zinc-700 transition duration-300 hover:text-zinc-900">
                            Pricing
                        </a>
                    </li>
                    <li class="h-16 flex-shrink-0 border-b border-zinc-100 md:border-b-0 md:h-full">
                        <a href="{{ route('blog') }}" class="flex md:px-0 px-6 items-center h-full hover:bg-zinc-100 md:hover:bg-transparent text-sm font-semibold text-zinc-700 transition duration-300 hover:text-zinc-900">Blog</a>
                    </li>
