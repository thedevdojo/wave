...
<div class="max-w-4xl mx-auto px-4 py-10">
    <h1 class="text-3xl font-bold mb-6">AI Post Generator</h1>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                saveGeneratedPost(data.post, topic);
            })
            .catch(error => {
                generateBtn.disabled = false;
                generateBtn.innerHTML = 'Generate Post';
            ...
            .then(data => {
                ...
                if (data.posts && data.posts.length > 0) {
                    data.posts.forEach(post => {
                        ...
                        postElement.className = 'bg-white rounded-lg shadow p-4 mb-4';
                        
                        const postContent = document.createElement('p');
                        postContent.className = 'text-gray-800 mb-2';
                    ...
                    postsHistory.innerHTML = '<p class="text-center text-gray-500">No posts found.</p>';
                }
            })
            .catch(error => {
                console.error('Error loading post history:', error);
                postsHistory.innerHTML = `<p class="text-center text-red-500">Error loading posts: ${error.message}</p>`;
            });
        }
    });
</script>
