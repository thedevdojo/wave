            ...
            <div class="w-full max-w-4xl space-y-6">
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:items-end">
                        ...
                        <div class="flex-1">
                            <label for="filterAction"
                                   class="block mb-2 text-sm font-medium text-zinc-700 dark:text-zinc-300">Filter by
                                Action</label>
                            <select
                    ...
                    @else
                        <div class="space-y-4">
                            @foreach($activities as $activity)
                                <div
                                    class="flex gap-4 p-4 transition-colors border rounded-lg border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800">
                                            <x-dynamic-component
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-start justify-between">
                                            <div>
                                                ...
                                                @endif
                                                <div
                                                    class="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-xs text-zinc-500 dark:text-zinc-500">
                ...
                <div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800">
                    <div class="flex gap-3">
                        <svg class="flex-shrink-0 w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor"
                             viewBox="0 0 20 20">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-sm text-blue-800 dark:text-blue-200">
                                Review your activity log regularly to ensure all actions were performed by you. If you
                                notice any suspicious activity, change your password immediately and contact support.
                            </p>
                        </div>
                    </div>
                </div>
