    ...
    public function exportData()
    {
        ...
        $data = [
            ...
            'api_keys' => $user->apiKeys()->get()->map(function ($key) {
                return [
                    'name' => $key->name,
                    'key' => substr($key->key, 0, 10).'...'.substr($key->key, -5),
            ...
            <div class="w-full max-w-lg space-y-6">
                ...
                <div class="p-4 border rounded-md border-zinc-200 dark:border-zinc-700">
                    ...
                    <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                        ...
                        <a href="{{ route('settings.deletion') }}" wire:navigate class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Account Deletion</a> page.
                    </p>
                </div>
            </div>
        </x-app.settings-layout>
