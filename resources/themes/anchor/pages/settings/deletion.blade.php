    ...
    <div class="relative">
        <x-app.settings-layout
            ...
            <div class="w-full max-w-2xl space-y-6">
                ...
                @if($isScheduled)
                    <div class="p-6 rounded-lg border border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/30">
                ...
                @else
                    <x-card class="p-6">
                        <div class="space-y-4">
                            <div>
                                <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Delete Your Account</h3>
                                <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                                    Once you delete your account, there is no going back. Please be certain.
                                </p>
                            </div>

                            <div class="p-4 rounded-lg border border-red-200 bg-red-50 dark:border-red-900/50 dark:bg-red-950/20">
                                <div class="flex gap-3">
                                    <svg class="flex-shrink-0 w-5 h-5 text-red-600 dark:text-red-400 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <form wire:submit="scheduleAccountDeletion" class="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="password"
                                        wire:model="password"
                                        class="w-full px-3 py-2 text-sm border rounded-lg border-zinc-300 bg-white text-zinc-900 placeholder:text-zinc-400 focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-500 dark:focus:ring-offset-zinc-800"
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input
                                            ...
                                            class="w-4 h-4 text-red-600 rounded border-zinc-300 focus:ring-red-500 dark:border-zinc-600 dark:bg-zinc-900">
                                    </div>
                                    <label for="confirmDeletion" class="ml-3 text-sm text-zinc-700 dark:text-zinc-400">
                    ...
                    <div class="p-4 rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30">
                        <div class="flex gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-medium text-blue-900 dark:text-blue-100">Grace Period</h4>
