                ...
                @else
                    <x-card class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="p-4 rounded-lg border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950/30">
                                <div class="flex gap-3">
                                    <svg class="shrink-0 w-5 h-5 text-red-600 mt-0.5 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20">
