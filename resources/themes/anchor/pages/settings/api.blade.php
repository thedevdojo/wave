                ...
                <div class="flex flex-col">
                    <form wire:submit="add" class="w-full max-w-lg">
                        ...
                        <div class="w-full pt-6 text-right">
                            <x-button type="submit">Crează Cheia Nouă</x-button>
                        </div>
                    </form>
                    <hr class="my-8 border-zinc-200">
                    <x-elements.label class="block text-sm font-medium leading-5 text-zinc-700">Cheile API Curente</x-elements.label>
                    <div class="pt-5">
                        {{ $this->table }}
                    </div>
                </div>
