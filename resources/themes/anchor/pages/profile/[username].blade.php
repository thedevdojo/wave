...
<x-dynamic-component :component="((auth()->guest()) ? 'layouts.marketing' : 'layouts.app')" bodyClass="bg-zinc-50">
    @volt('wave.profile')
        ...
        <x-dynamic-component :component="((auth()->guest()) ? 'container' : 'app.container')">
            ...
            <div class="flex lg:flex-row flex-col @guest pb-20 pt-10 @endguest space-x-5 rtl:space-x-reverse h-full">
                ...
                <x-card class="lg:p-10 lg:text-start text-center lg:w-2/3 lg:flex-2">
